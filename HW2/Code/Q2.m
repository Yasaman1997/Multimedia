...
if ~img_color
    ...
    imwrite(dithered_img1, fullfile(output_dir, 'ordered_dithered_2.jpg'));
    imwrite(dithered_img2, fullfile(output_dir, 'ordered_dithered_4.jpg'));
    imwrite(dithered_img3, fullfile(output_dir, 'FS_dithered.jpg'));
else
    red = img(:,:,1);
    green = img(:,:,2);
    blue = img(:,:,3);
